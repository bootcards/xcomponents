...
/* xcomponents 0.1.0 2015-04-09 2:49 */
var app = angular.module("xcomponents");
...
app.factory('xcUtils', function($rootScope, $http) {
	...
	return {
		...
		calculateFormFields : function(form, model) {
...
angular.module("xc-list-categorised.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("xc-list-categorised.html",
    ...
    "					</div>\n" +
    "				\n" +
    "					<a class=\"list-group-item\" ng-repeat=\"item in group.entries | filter : filter\" \n" +
    "						ng-click=\"itemClick(item)\"\n" +
    "						ng-class=\"{'active' : selected == item}\">\n" +
    "\n" +
    "						<!--(placeholder) icon-->\n" +
...
angular.module("xc-list-detailed.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("xc-list-detailed.html",
    ...
    "			<div class=\"list-group\">\n" +
    "				\n" +
    "				<a class=\"list-group-item animate-repeat\" ng-repeat=\"item in items | filter: filter | limitTo : itemsShown track by item.id\" \n" +
    "					ng-click=\"itemClick(item)\"\n" +
    "					ng-class=\"{'active' : selected == item}\">\n" +
    "\n" +
    "					<div class=\"row\">\n" +
